    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>اضافة كتاب جديد</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="book_add.php">
          		  <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input required type="text" class="form-control" id="isbn" name="isbn" required>
                  	</div>
                </div>
                <div class="form-group">
                    <label for="title" class="col-sm-3 control-label">اسم الكتاب</label>
                ...
                <div class="form-group">
                    <label for="category" class="col-sm-3 control-label">الفئة</label>
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="category" id="category" required>
                        ...
                        <?php
                          ...
                          $sql->execute();
                          while($crow = $sql->fetch(PDO::FETCH_OBJ)){
                            echo "
                ...
                <div class="form-group">
                    <label for="publisher" class="col-sm-3 control-label">السعر</label>
                ...
                <div class="form-group">
                    <label for="qiute" class="col-sm-3 control-label">الكمية</label>

                    <div class="col-sm-9">
                      <input required type="text" class="form-control"  name="qiute">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="date">
                        <input required type="text" class="form-control" id="datepicker_add" name="pub_date">
                      </div>
                    </div>
                </div>
          	</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>تعديل الكتاب</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="book_edit.php">
            		<input required type="hidden" class="bookid" name="id">
                <div class="form-group">
                    <label for="edit_isbn" class="col-sm-3 control-label">ISBN</label>

                    <div class="col-sm-9">
                      <input required type="text" class="form-control" id="edit_isbn" name="isbn">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input required type="text" class="form-control" id="edit_author" name="author">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input required type="text" class="form-control" id="edit_publisher" name="publisher">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="date">
                        <input required type="text" class="form-control" id="datepicker_edit" name="pub_date">
                      </div>
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> الغاء</button>
            	<button type="submit" class="btn btn-success btn-flat" name="edit"><i class="fa fa-check-square-o"></i> تأكيد</button>
            	</form>
          	</div>
        </div>
    </div>
